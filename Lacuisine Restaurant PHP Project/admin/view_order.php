                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											$sql="SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.CNIC=users_orders.CNIC where OID='".$_GET['user_upd']."'";
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['username']; ?></center></td>
													   <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['OID']);?>');" title="Update order">
											...
											<tr>
												<td><strong>Title:</strong></td>
												    <td><center><?php echo $rows['FName']; ?></center></td>
													    <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['OID']);?>');" title="Update order">

                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.CNIC=users_orders.CNIC ";
																		   ...
																		   <?php 
																			...
																			?>
																						<?php																									
																							...
																							?>
																									 <td>
																									 <a href="delete_orders.php?order_del=<?php echo $rows['OID'];?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																								<?php
																								echo '<a href="view_order.php?user_upd='.$rows['OID'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td>
																									</tr>';

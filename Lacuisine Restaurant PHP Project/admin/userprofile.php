...
$sql=mysqli_query($db,"update users_orders set status='$status' where OID='$form_id'");
...
$ret1=mysqli_query($db,"select * FROM users_orders where OID='".$_GET['newform_id']."'");
$ro=mysqli_fetch_array($ret1);
$ret2=mysqli_query($db,"select * FROM users where CNIC='".$ro['CNIC']."'");

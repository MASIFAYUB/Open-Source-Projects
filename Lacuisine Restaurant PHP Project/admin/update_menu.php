                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="d_name" value="<?php echo $roww['FName'];?>" class="form-control" placeholder="Chicken Biryani">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="about" value="<?php echo $roww['Description'];?>" class="form-control form-control-danger" placeholder="Description">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>

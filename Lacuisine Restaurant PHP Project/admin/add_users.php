...
if(isset($_POST['submit'] ))
{
    ...
    elseif(mysqli_num_rows($CNIC) > 0)  //check CNIC
    {
       $error = '<div class="alert alert-danger alert-dismissible fade show">
                                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                <strong>CNIC already exist!</strong>
                                                            </div>';
    }
	...
	$mql = "INSERT INTO users(CNIC,username,f_name,l_name,email,phone,password,address) VALUES('".$_POST['cnic']."','".$_POST['uname']."','".$_POST['fname']."','".$_POST['lname']."','".$_POST['email']."','".$_POST['phone']."','".md5($_POST['password'])."','".$_POST['address']."')";
	mysqli_query($db, $mql);
